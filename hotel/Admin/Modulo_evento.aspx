...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
 ...
 <asp:Label ID="Label2" runat="server" Text="buscar: "></asp:Label>
    ...
    <li class="list-group-item">
        <!--aca va el gridview-->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo_evento" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
