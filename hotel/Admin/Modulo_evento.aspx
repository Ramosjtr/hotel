...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
 ...
 <asp:Label ID="Label2" runat="server" Text="buscar: "></asp:Label>
    ...
    <li class="list-group-item">
        ...
        <!--aca va el gridview-->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo_evento" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" Cssclass="table table-hover">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nombre" HeaderText="Nombre" SortExpression="nombre" />
                 <asp:BoundField DataField="costo" HeaderText="Costo" SortExpression="nombre" />
...
<asp:Panel ID="Panel1" runat="server" style="display:none; background: white; Width:50%; height:auto">
                         ...
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                   <asp:TextBox ID="codigo" runat="server" CssClass="estilo1" value="EV-"></asp:TextBox>
                                    </div>
                                 </div>
                                <div class="form-group">
    ...
    <ajaxToolkit:ModalPopupExtender ID="Button1_ModalPopupExtender" runat="server" BehaviorID="Button1_ModalPopupExtender" DynamicServicePath="" TargetControlID="Button1" BackgroundCssClass="modalbakground" PopupControlID="panel2" >
    </ajaxToolkit:ModalPopupExtender>
     <asp:Panel ID="Panel2" runat="server"  style="display:none; background: white; Width:50%; height:auto">
          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
              <ContentTemplate>
                  <div class="modal-header modal-primary"  >
                   <h3 id="modalupdate" > Actualizar Evento</h3>
                       </div>
                        <div class="modal-body" >
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
    ...
    <asp:Panel ID="Panel3" runat="server" style="display:none; background: white; Width:50%; height:auto">
         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
             <ContentTemplate>
 <div class="modal-header">
                          <h3 id="mymodallabel2" "> Eliminacion De Evento</h3>
                       </div>
                       <div class="modal-body">
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
