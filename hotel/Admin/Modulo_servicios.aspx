<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/admin.Master" CodeBehind="Modulo_servicios.aspx.vb" Inherits="hotel.Modulo_servicios" %>
...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
    ...
    <h3 class="panel-title">Gestionar Servicios</h3>
  </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                     <div class="modal-header">
                          <h3 id="mymodallabel" style="margin-left: 250px;">Nuevo Servicio</h3>
                       </div>
