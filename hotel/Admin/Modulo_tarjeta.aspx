<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/admin.Master" CodeBehind="Modulo_tarjeta.aspx.vb" Inherits="hotel.Modulo_tarjeta" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                     <div class="modal-header">
                          <h3 id="mymodallabel" style="margin-left: 250px;">Nueva Tarjeta</h3>
                       </div>
                         ...
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal"> 
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                            <asp:TextBox ID="titular" runat="server"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
