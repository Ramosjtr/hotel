...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
 ...
 <asp:Label ID="Label2" runat="server" Text="buscar: "></asp:Label>
    ...
    <li class="list-group-item">
        ...
        <!--aca va el gridview-->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo_usuario"  ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" Cssclass="table table-hover">
   ...
   <asp:Button ID="Button2" runat="server" Text="Button" Width="56px" Style="display:none"/>
          ...
          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
              <ContentTemplate>
                  <div class="modal-header modal-primary"  >
                   <h3 id="modalupdate" > Actualizar Usuario</h3>
                       </div>
                        <div class="modal-body" >
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                           <asp:TextBox ID="usuario_m" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Contraseña:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="contraseña_m" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                            </div>
                            </div> 
    ...
    <ajaxToolkit:ModalPopupExtender ID="Button10_ModalPopupExtender" runat="server" BehaviorID="Button10_ModalPopupExtender" DynamicServicePath="" TargetControlID="Button10" BackgroundCssClass="modalbakground" PopupControlID="panel3">
     ...
     <asp:Panel ID="Panel3" runat="server" style="display:none; background: white; Width:50%; height:auto">
         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
             <ContentTemplate>
 <div class="modal-header">
                          <h3 id="mymodallabel2" "> Eliminacion De usuarios</h3>
                       </div>
                       <div class="modal-body">
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label  class="col-sm-4 control-label">Nombre:</label>
                                    <div class="col-sm-8">
                                      <asp:TextBox ID="usuario_e" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div>   
                                   <div class="form-group">
                                    <label  class="col-sm-4 control-label">Contraseña:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="contraseña_e" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                            </div>
                       </div>     
