...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
 ...
 <asp:Label ID="Label2" runat="server" Text="buscar: "></asp:Label>
    ...
    <li class="list-group-item">
        ...
        <!--aca va gridview-->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo_habitacion"  ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" Cssclass="table table-hover">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                            <asp:TextBox ID="metros" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Cantida de Camas:</label>
                                    <div class="col-sm-8">
                                           <asp:TextBox ID="Cantidad_camas" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                 <div class="form-group">
          ...
          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
              <ContentTemplate>
                  <div class="modal-header modal-primary"  >
                   <h3 id="modalupdate" > Actualizar Habitaciones</h3>
                       </div>
                        <div class="modal-body" >
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label  class="col-sm-4 control-label">Metros:</label>
                                    <div class="col-sm-8">
                                           <asp:TextBox ID="metros_m" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Cantidad de Camas:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="cantidad_m" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                  <div class="form-group">
                                    <label  class="col-sm-4 control-label">Costo:</label>
    ...
    <ajaxToolkit:ModalPopupExtender ID="Button10_ModalPopupExtender" runat="server" BehaviorID="Button10_ModalPopupExtender" TargetControlID="Button10" BackgroundCssClass="modalbakground" PopupControlID="panel3">
     ...
     <asp:Panel ID="Panel3" runat="server" style="display:none; background: white; Width:50%; height:auto">
         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
             <ContentTemplate>
 <div class="modal-header">
                          <h3 id="mymodallabel2" "> Eliminacion De Habitacion</h3>
                       </div>
                       <div class="modal-body">
                         <%--cuerpo del modal--%>
                            <div class="form-horizontal">
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label  class="col-sm-4 control-label">Metros:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="metros_e" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Cantidad De Camas:</label>
                                    <div class="col-sm-8">
                                             <asp:TextBox ID="cantidad_e" runat="server" CssClass="estilo1"></asp:TextBox>
                                    </div>
                                 </div> 
                            </div>
                       </div>     
