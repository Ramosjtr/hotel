...
<%--  <div class="panel-heading">Listado De Proveedores</div>--%>
 ...
 <asp:Label ID="Label2" runat="server" Text="buscar: "></asp:Label>
    ...
    <li class="list-group-item">
        <!--aca va gridview-->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo_habitacion"  ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label  class="col-sm-4 control-label">Metros:</label>
                                    <div class="col-sm-8">
                                           <asp:TextBox ID="metros_m" runat="server"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Cantidad de Camas:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="cantidad_m" runat="server"></asp:TextBox>
                                    </div>
                                 </div> 
                                  <div class="form-group">
                                    <label  class="col-sm-4 control-label">Costo:</label>
                                 ...
                                 <div class="form-group">
                                    <label  class="col-sm-4 control-label">Tipo De Habitacion:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="tipo_m" runat="server"></asp:TextBox>
                                    </div>
                                 </div>                               
                            </div>
                            </div> 
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label  class="col-sm-4 control-label">Metros:</label>
                                    <div class="col-sm-8">
                                         <asp:TextBox ID="metros_e" runat="server"></asp:TextBox>
                                    </div>
                                 </div> 
                                      <div class="form-group">
                                    <label  class="col-sm-4 control-label">Cantidad De Camas:</label>
                                    <div class="col-sm-8">
                                             <asp:TextBox ID="cantidad_e" runat="server"></asp:TextBox>
                                    </div>
                                 </div> 
                            </div>
                       </div>     
